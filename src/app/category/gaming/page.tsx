...
export const metadata = {
  ...
  description: "Gaming products category",
};
...
export default async function page() {
  ...
  const gamingProducts = await res.json();
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-slate-900 to-gray-800">
      <div className="max-w-6xl mx-auto px-4">
        ...
        <p className="text-gray-300 text-center pb-8 max-w-2xl mx-auto">
          Discover our premium collection of gaming equipment and entertainment electronics
        </p>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 pb-8">
          {gamingProducts.products.map((product: Products) => (
