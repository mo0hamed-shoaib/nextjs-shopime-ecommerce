...
export const metadata = {
  title: "TV Products",
  description: "TV products category",
};
...
export default async function page() {
  ...
  const tvProducts = await res.json();
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-slate-900 to-gray-800">
      <div className="max-w-6xl mx-auto px-4">
        ...
        <p className="text-gray-300 text-center pb-8 max-w-2xl mx-auto">
          Discover our premium collection of televisions and entertainment systems
        </p>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 pb-8">
          {tvProducts.products.map((product: Products) => (
